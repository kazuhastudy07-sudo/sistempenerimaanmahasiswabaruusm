...
<script type="text/javascript">
 ...
 $gel=mysqli_fetch_array(mysqli_query($con, "SELECT * FROM gelombang
      WHERE id_gelombang ='$r[id_gel]'"));
     ...
     <h3 style="text-align: center;border-bottom: 1px dashed #007bff;">KARTU PENDAFTARAN MAHASISWA BARU TAHUN <?php echo date(Y);?></u></h3>
  ...
  <h5 style="margin-top: -10px;">Program Studi Pilihan:<br/><span style="background: #007bff; padding: 2px;border-radius: 4px;color: #fff;"><?php echo "$r[nama_pro]"; ?></span></h5>
  <p style="font-size: 8px;margin-top: -10px;"><i>Silahkan mengikuti ujian online sesuai dengan jadwal yang telah ditentukan</i></p>
  <h4 style="width: 200px;margin-top: -85px;margin-left:200px;text-align: center;text-transform: uppercase; padding: 5px;border: 2px dotted #222;"><?php echo "$gel[nama_gelombang]"; ?> <br/><?php echo "Rp. ". number_format($gel[biaya], 0, ".", "."). ""?> </h4>
