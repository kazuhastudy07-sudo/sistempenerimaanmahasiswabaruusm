...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed pace-white">
  <div class="wrapper">
    ...
    <head>
      ...
      <title><?php echo "$iden[aplikasi]";?> | USER</title>
      <link rel="stylesheet" href="../assets/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
      <link rel="stylesheet" href="../assets/dist/css/adminlte.min.css">
      <link rel="stylesheet" href="../assets/plugins/select2/css/select2.min.css"/>
      <link rel="stylesheet" href="../assets/plugins/font-awesome-4.7.0/css/font-awesome.min.css">
    ...
    <body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed pace-white">
      ...
      <span class="d-none d-lg-block ketikan">APLIKASI <?php echo "$iden[aplikasi]";?> - <?php echo "$iden[nama]";?></span><span class="d-block d-lg-none d-xl-none d-xs-block"><img src="../assets/dist/img/logo/<?php echo "$logo";?>" alt="Logo" style="width:30px;"><b style="font-family: 'Orbitron', sans-serif;text-transform: uppercase;font-size: 10px;padding-left: 10px;"><?php echo "$iden[aplikasi]";?></b></span>  
     </a>
          </li>
        </ul>
      ...
      <aside class="main-sidebar sidebar-<?php echo "$iden[mode]"; ?>-<?php echo "$iden[sidebar]"; ?> elevation-4">
        ...
        <a type="button" onclick="window.location.href='administrator'" class="brand-link text-white <?php echo "$iden[color]"; ?>">
          <img src="../assets/dist/img/logo/<?php echo "$iden[logo]";?>" alt="AdminLTE Logo" class="brand-image img-rounded elevation-3"
          style="opacity: ">
          <span style="text-transform: uppercase;font-size: 10px;font-family: 'Orbitron', sans-serif;text-transform: uppercase;"  class="brand-text small font-weight-light"><?php echo "$iden[aplikasi]";?></span>
        </a>
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
         ...
         <div class="info" style="margin-top: -10px;">
          ...
          <br><span class="badge bg-red"><i class=" fa fa-dot-circle-o faa-pulse animated"></i> PMB Online</span>
        </div>
      </div>
          ...
          <nav class="mt-2 small">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
              <li class="nav-item has-treeview">
                <a type="button" onclick="window.location.href='register'" class="nav-link active">
                  <i class="nav-icon fa fa-user-plus faa-tada animated-hover"></i>
                  <p>
                    REGISTRASI ANGGOTA
                  </p>
                </a>
              ...
              <li class="nav-item has-treeview menu-open">
                <a type="button" onclick="window.location.href='./'" class="nav-link bg-warning">
                  <i class="nav-icon fa fa-sign-in faa-tada animated-hover"></i>
                  <p>
                    LOGIN AREA
                  </p>
                </a>
                  ...
                  <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item">
                      <ol class="breadcrumb float-sm-left">
                        ...
                        <li class="breadcrumb-item active">Registrasi Anggota</li>
                      </ol>
                    </li>
                  </ol>
                </div><!-- /.col -->
              ...
              <script type="text/javascript">
                $(function() {
                  ...
                  Swal.fire({
                    ...
                    title: 'BERHASIL!',
                    text: 'Anda berhasil mendaftar sebagai anggota, silahkan login',
            ...
            <div class="container-fluid">
              ...
              <div class="card">
                <div class="card-header <?php echo "$iden[color]";?>">
                  <h3 class="card-title"><b><i class="fa fa-user-plus"></i> Form Registrasi Anggota</b></h3>
                  <div class="card-tools">
                    ...
                    <div class="card-body">
                      <form action="action/anggota_save_user.php" method='POST' enctype='multipart/form-data'>
                        <div class="row">
                          <div class="col-sm-6 col-xs-6">
                            <div class="form-group">
                              <label>Jenis Bidang Keanggotaan <!-- <badge class="text-red">*</badge> --></label>
                              <select class="form-control" name="id_jeniskeanggotaan" id="jeniskeanggotaan" required="true">
                                <option></option>
                                <?php
                          ...
                          <div class="col-sm-6 col-xs-6">
                            <div class="form-group">
                              <label>Jabatan</label>
                              <input class="form-control" type="text" value="<?php echo $_SESSION['jabatan']; ?>" name="jabatan" placeholder="Tuliskan Nama Jabatan" required="true">
                            </div>
                          </div>
                        ...
                        <div class="row">
                          <div class="col-sm-6 col-xs-6">
                            <div class="form-group">
                              <label>NIK</label>
                              <input class="form-control" type="text" value="<?php echo $_SESSION['nik']; ?>" name="nik" placeholder="Tuliskan Nomor Induk Kependudukan maksimal 16 Angka" maxlength="16" onkeypress="return hanyaAngka (event)" required="true">
                            </div>
                          </div>
                          <div class="col-sm-6 col-xs-6">
                            <div class="form-group">
                              <label>Nama Lengkap <badge class="badge bg-red">Bisa Ditambahkan Gelar</badge></label>
                              <input class="form-control" type="text" name="name" placeholder="Tuliskan Nama Lengkap dan Gelar" value="<?php echo $_SESSION['name'] ?>" required="true">
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          <div class="col-sm-6 col-xs-6">
                            <div class="form-group">
                              ...
                              <input class="form-control" type="text" name="tmp_lhr" placeholder="Tuliskan Nama Tempat Lahir" value="<?php echo $_SESSION['tmp_lhr']; ?>" required="true">
                          ...
                          <div class="col-sm-6 col-xs-6">
                            <div class="form-group">
                              ...
                              <input class="form-control" type="date" id="tgl_lhr" name="tgl_lhr" value="<?php echo $_SESSION['tgl_lhr'] ?>" required="true">
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row"> 
                          <div class="col-sm-6 col-xs-6">
                            <div class="form-group">
                              ...
                              <select class="form-control" name="id_jk" id="jk" required="true">
                                <option></option>
                                <?php
                          ...
                          <div class="col-sm-6 col-xs-6">
                            <div class="form-group">
                              ...
                              <select class='form-control' id="agama" name="id_agm" required="true">
                                <option></option>
                                <?php
                        ...
                        <div class="row">
                          <div class="col-sm-6 col-xs-6">
                            <div class="form-group">
                              ...
                              <select class="form-control" id="provinsi" name="id_prov" required="true">
                                <option></option>
                                <?php 
                          ...
                          <div class="col-sm-6 col-xs-6">
                            <div class="form-group">
                              ...
                              <select class="form-control" id="kota" name="id_kab" required="true">
                                <option> </option>
                        ...
                        <div class="row">
                          <div class="col-sm-6 col-xs-6">
                            <div class="form-group">
                              ...
                              <select class="form-control" id="kecamatan" name="id_kec" required="true">
                                <option></option>
                                <?php 
                          ...
                          <div class="col-sm-6 col-xs-6">
                            <div class="form-group">
                              ...
                              <select class="form-control" id="kelurahan" name="id_kel" required="true">
                                <option></option>
                                <?php 
                        ...
                        <div class="row">
                          <div class="col-sm-6 col-xs-6">
                            ...
                            <div class="form-group">
                              ...
                              <input class="form-control" type="text" name="tgl_bergabung" vvalue="<?php echo $_SESSION['tgl_bergabung'] ?>" required="true">
                            </div>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-sm-6 col-xs-6">
                            <div class="form-group">
                              ...
                              <select class="form-control" name="id_pekerjaan" id="pekerjaan" required="true">
                                <option></option>
                                <?php
                          ...
                          <div class="col-sm-6 col-xs-6">
                            <div class="form-group">
                              ...
                              <select class="form-control" name="id_pendidikan" id="pendidikan" required="true">
                                <option></option>
                                <?php
                        ...
                        <div class="row">
                          <div class="col-sm-6 col-xs-6">
                            <div class="form-group">
                              ...
                              <input class="form-control" type="email" placeholder="Tuliskan Alamat Email Yang Aktif" name="email" value="<?php echo $_SESSION['mail']; ?>" required="true">
                            </div>
                          </div> 
                          <div class="col-sm-6 col-xs-6">
                            <div class="form-group">
                              <label>Nomor Handphone/Whatsapp <badge class="badge bg-red">Digunakan Sebagai Password Default Login</badge></label>
                              <input class="form-control" type="number" placeholder="Tuliskan Nomor HP/Whatsapp Yang Aktif" name="hp" value="<?php echo $_SESSION['hp']; ?>" required="true">
                            </div>
                          </div> 
                        </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                <div class="custom-file">
                                  <input type="file" name="ktp" multiple="true" accept='image/*'  class="custom-file-input" id="exampleInputFilee"  required="true">
                     ...
                     <div class="card-footer">
                      <div class="row">
                        ...
                        <div class="col-sm-4">
                          <button style='width: 100px;border-radius: 20px;border: 2px solid #FFFFFF;' type="submit" class="btn btn-sm btn-xs-2 btn-primary pull-right"><i class="fa fa-check-circle"></i> SIMPAN</button>
                          <a style='width: 100px;border-radius: 20px;border: 2px solid #FFFFFF;' onclick="window.location.href='./'" type="button" class="btn btn-sm btn-xs-2 btn-danger text-white"><i class="fa fa-times-circle"></i> BATAL</a>
                        </div>
                      </div>
                    </div>
                  </form>
...
<footer class="main-footer small <?php echo "$iden[color]"; ?>">
  <strong>Copyright &copy; <?php echo date("Y"); ?>. <a href="http://adminlte.io" class="text-white" style="text-transform: uppercase;"> Aplikasi EKTA - <?php echo $iden['nama'];?></a></strong>
