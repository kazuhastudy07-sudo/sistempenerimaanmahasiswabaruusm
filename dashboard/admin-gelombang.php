...
<div class="content-wrapper">
	...
	<section class="content">
		<div class="container-fluid">
			...
			<div class="card">
				<div class="card-header <?php echo "$iden[color]"; ?>">
					<h3 class="card-title"><i class="fa fa-table"></i> <b>DATA GELOMBANG PENDAFTARAN</b></h3>
					<div class="card-tools">
						<button type="button" onclick="window.location.href='gelombangtambah'" class="btn btn-tool bg-navy" data-card-widget="collapse" data-toggle="tooltip" title="Tambah Data"><i class="fa fa-plus-circle"></i> Tambah Data</button>
									...
									var table = $('#tabeldata').DataTable( {
										...
										{ "targets": 4, "className": 'center' },
										{
											...
											"render": function(data, type, full) {
												return '<center><div class="btn-group"><button type="button" style="width:25px;" onclick="window.location.href=\'gelombangubah?id='+data+'\'" class="btn btn-xs bg-primary" data-toggle="tooltip" title="Ubah Data"><i class="fa fa-edit"></i> </button><button type="button" style="width:25px;" class="btn btn-xs bg-red hapusgelombang" data-id="'+data+'" data-toggle="tooltip" title="Hapus Data"><i class="fa fa-trash"></i></button></div></center>';
											} 
										} 
										],
		...
		<script>
			$(function()
			{
				$(document).on('click','.hapusgelombang',function(e)
				{
					e.preventDefault();
					$("#hapusModal").modal('show');
					$.post('gelombang_hapus.php',
						{id_gelombang:$(this).attr('data-id')},
						function(html)
						{
		...
		<form action="action/gelombang_delete.php" method="GET" class="form-horizontal" enctype="multipart/form-data">
			<div class="modal fade" id="hapusModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						<div class="modal-header <?php echo "$iden[color]";?>">
							<h5 class="modal-title" id="exampleModalLabel"><i class="fa fa-edit"></i> Form Data Gelombang Pendaftaran</h5>
