		...
		<div class="container-fluid">
			...
			<div class="card">
				<div class="card-header  <?php echo "$iden[color]"; ?>">
					<h3 class="card-title"><i class="fa fa-edit (alias)"></i> <b>FORM UBAH DATA BERANDA</b></h3>
					<center></center>
					<div class="card-tools">
						...
						<!-- /.card-header -->
						<div class="card-body">
							<form class='form-horizontal' role='form' method=POST action='action/beranda_update.php' enctype='multipart/form-data'>
								<?php
								$r=mysqli_fetch_array(mysqli_query($con, "SELECT * FROM iklan WHERE id_iklan ='3'"));
								?>
								...
								<div class="form-group">
									<div class="row">
										<div class="col-sm-6">
											<label>GAMBAR IKLAN BERANDA 1</label><br/>
											<img class="img-responsive img-rounded img-thumbnail" alt="Responsive image" src="../assets/dist/img/iklan/<?php echo $r['gambar_iklan'];?>" style="width: 50%; height: 200px; object-fit: cover;overflow: hidden;" alt="img-responsive">
											<br/>
										...
										<div class="col-sm-6">
											<label>GAMBAR IKLAN BERANDA 2</label><br/>
											<img class="img-responsive img-rounded img-thumbnail" alt="Responsive image" src="../assets/dist/img/iklan/<?php echo $r['gambar_iklan2'];?>" style="width: 50%; height: 200px; object-fit: cover;overflow: hidden;" alt="img-responsive">
											<br/>
											<label>Ganti Gambar</label>
											<div class="input-group">
												<div class="custom-file">
													<input type="file" name="gambar_iklan2" multiple="true" accept='image/*'  class="custom-file-input" id="exampleInputFile2">
													<label class="custom-file-label" for="exampleInputFile">Unggah Gambar Baru</label>
												</div>
											</div>
										</div>
