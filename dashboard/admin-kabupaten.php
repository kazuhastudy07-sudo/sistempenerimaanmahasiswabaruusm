...
<div class="content-wrapper">
	...
	<section class="content">
		<div class="container-fluid">
			<form class='form-horizontal' role='form' method=POST action='action/kabupaten_save.php' enctype='multipart/form-data'>
				<div class="card card-<?php echo "$iden[sidebar]"; ?>">											
					<div class="card-header">
						<h3 class="card-title"><i class="fa fa-plus-circle"></i> TAMBAH DATA KABUPATEN/KOTA</h3>
						<div class="card-tools">
								...
								<div class="row">
									<div class="form-group  col-sm-3 col-xs-3">
										<select  name="a" class="form-control select2" style="width: 100%;" required>
											...
											<?php 
											$tampil = mysqli_query($con, "SELECT * FROM provinces ORDER BY id_prov ");
									...
									<div class="form-group  col-sm-3 col-xs-3">
										<!-- teks dan angka -->
										<input type="text" name="b" class="form-control" placeholder="Tuliskan 4 Angka Kode Kab/Kota" required maxlength="4">
										<!-- hanya angka -->
										<!-- <input type="text" name="b" class="form-control" placeholder="Tuliskan 4 Angka Kode Kab/Kota" required maxlength="4" onkeypress="return hanyaAngka (event)"/> -->
									</div>
									<div class="form-group  col-sm-3 col-xs-3">
										<input type="text" name="c" class="form-control" placeholder="Tuliskan Nama Kab/Kota" required>
									</div>
							...
							<div class="card-footer">
								Kode kabupaten/Kota yang terdiri 4 digit angka diambil dari web <a href="https://sig-dev.bps.go.id/webgis/pencariankodenama" data-toggle="tooltip" title="Klik Untuk Melihat Kode Wilayah">Badan Pusat Statistik</a> yang berdasarkan wilayah kerja statistik BPS.
							</div>
						</div>
					</form>
					<!-- Default box -->
					<div class="card">
						<div class="card-header <?php echo "$iden[color]"; ?>">
							<h3 class="card-title"><i class="fa fa fa-table"></i> <b>DATA TABEL KABUPATEN/KOTA</b></h3>
							<center></center>
							<div class="card-tools">
								<button type="button" class="btn btn-tool" data-card-widget="collapse" data-toggle="tooltip" title="Collapse">
									<i class="fa fa-minus"></i></button>
											...
											<script type="text/javascript">
												$(function() {
													...
													Swal.fire({
														...
														text: 'Data kabupaten berhasil diupdate',
														footer: 'APLIKASI <?php echo "$iden[aplikasi]";?>'
													}).then(function() {
														window.location = "kabupaten";
													});
											...
											<script type="text/javascript">
												$(function() {
													...
													Swal.fire({
														...
														text: 'Data kabupaten berhasil dihapus',
														footer: 'APLIKASI <?php echo "$iden[aplikasi]";?>'
													}).then(function() {
														window.location = "kabupaten";
													});
