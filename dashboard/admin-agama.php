			...
			<form class='form-horizontal' role='form' method=POST action='action/agama_save.php' enctype='multipart/form-data'>
				...
				<div class="card card-<?php echo "$iden[sidebar]"; ?>">											
					<div class="card-header">
						<h3 class="card-title"><i class="fa fa-plus-circle"></i> TAMBAH DATA AGAMA</h3>
						<div class="card-tools">
							...
							<div class="card-body">
								<div class="row">
									<div class="form-group col-sm-5 col-xs-5">
										<center><input type="text" name="a" class="form-control" placeholder="Tuliskan kode agama" required maxlength="2"  onkeypress="return hanyaAngka (event)"/></center>
									</div>
									<div class="form-group col-sm-5 col-xs-5">
										<center><input type="text" name="b" class="form-control" placeholder="Tuliskan Nama Agama" required></center>
									</div>
							...
							<div class="card-footer">Anda dapat menambahkan nama agama pada kolom yang tersedia.
							</div>
						</div>
					</form>
					<!-- Default box -->
					<div class="card">
						<div class="card-header <?php echo "$iden[color]"; ?>">
							<h3 class="card-title"><i class="fa fa-table"></i> <b>DATA TABEL AGAMA</b></h3>
							<div class="card-tools">
								<button type="button" class="btn btn-tool" data-card-widget="collapse" data-toggle="tooltip" title="Collapse">
									<i class="fa fa-minus"></i></button>
									<button type="button" class="btn btn-tool" data-card-widget="remove" data-toggle="tooltip" title="Remove">
								...
								<div class="card-footer small text-red">
									<i class="fa fa-info-circle"></i> Mohon untuk tidak meng-hapus data agama, jika telah melakukan penginputan data anggota, karena akan menyebabkan data error!
								</div>
							</div>
						</div>
					</div>
