    ...
    <div class="container-fluid">
      ...
      <div class="card">
        <div class="card-header <?php echo "$iden[color]";?>">
          <h3 class="card-title"><i class="fa fa-list-ol"></i> <b>DATA PENDAFTAR PMB GELOMBANG 3</b></h3>
          ...
          <div class="card-tools">
            ...
            <button type="button" class="btn btn-xs btn-tool btn-light dropdown-toggle dropdown-icon" data-toggle="dropdown">
              ...
              <div class="dropdown-menu small" role="menu">
                ...
                <a class="dropdown-item small" onclick="window.location.href='pmbgelombang3'" type="button"><i class="fa fa-angle-right"></i> Gelombang 2</a>
              </div>
            </button>
            <button type="button"  onclick="window.location.href='excel/pmbgelombang3.php'" class="btn btn-xs btn-tool btn-light"  data-toggle="tooltip" title="Ekspor Data Ke Excel"><i class="fa fa-file-excel"></i> Ekspor Excel</button>
              ...
              <script type="text/javascript">
                $(document).ready(function(){
                  ...
                  var table = $('#tabel_kta').DataTable( {
                    ...
                    "processing": true,
                    "serverSide": true,
                    "ajax": 'serverside/pmb_gelombang3.php', 
                    ...
                    { "targets": 9, "orderable": false, "searchable": true, "className": 'center',
                    "render": function(data, type, row) {
...
<form action="action/pmbgelombang3_verifikasi.php" method="POST" class="form-horizontal" enctype="multipart/form-data">
...
<form action="action/pmbgelombang3_delete.php" method="GET" class="form-horizontal" enctype="multipart/form-data">
...
<form action="action/pmbgelombang3_reset.php" method="POST" class="form-horizontal" enctype="multipart/form-data">
