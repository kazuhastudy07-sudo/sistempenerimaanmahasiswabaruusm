        ...
        <div class="card-body">
          <div class="tab-content" id="custom-tabs-four-tabContent">
            ...
            <div class="tab-pane fade show active" id="custom-tabs-four-home" role="tabpanel" aria-labelledby="custom-tabs-four-home-tab">
              <form role="form" method="POST" action="action/pmbgelombang2_update.php" enctype='multipart/form-data'>
...
<footer class="main-footer small <?php echo "$iden[color]"; ?>">
  ...
  <div class="float-right d-none d-sm-inline-block">
    <b>Version 2021 | powered by <a type="button" onclick="window.location.href  <b>powered by <a type="button" href="#" onclick="window.open(href='./')" target='_blank' class="badge bg-white" data-toggle="tooltip" data-placement="bottom" title="Klik Developer"><i class="fa fa-code faa-pulse animated"></i> <?php echo "$iden[dev]"; ?></b></a>
  </div>
</footer>
