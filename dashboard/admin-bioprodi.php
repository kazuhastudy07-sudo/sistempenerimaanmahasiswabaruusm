			...
			<div class="card">
				<div class="card-header  <?php echo "$iden[color]"; ?>">
					...
					<div class="card-tools">
						...
						<!-- /.card-header -->
						<div class="card-body">
							<form class='form-horizontal' role='form' method=POST action='action/bioprodi_update.php' enctype='multipart/form-data'>
								<?php
								$r=mysqli_fetch_array(mysqli_query($con, "SELECT * FROM iklan WHERE id_iklan ='2'"));
								?>
								...
								<div class="form-group">
									<div class="row">
										<div class="col-sm-6">
											...
											<img class="img-responsive img-rounded img-thumbnail" alt="Responsive image" src="../assets/dist/img/iklan/<?php echo $r['gambar_iklan'];?>" style="width: 50%; height: 300px; object-fit: cover;overflow: hidden;" alt="img-responsive">
											<br/>
