              ...
              <script type="text/javascript">
                $(document).ready(function(){
                  ...
                  var table = $('#tabel_kta').DataTable( {
                    ...
                    "processing": true,
                    "serverSide": true,
                    "ajax": 'serverside/nilai_pmb_jalurpmdk.php', 
...

                    {
                      ...
                      "render": function(data, type, full) {  
                       return '<center><div class="btn-group"><a type="button" style="width:25px;" onclick="window.location.href=\'nilaipmbjalurpmdkcetak?id='+data+'\'" class="btn btn-xs bg-navy" data-toggle="tooltip" title="Cetak Hasil Seleksi"><i class="fa fa-print"></i> <?php echo $a; ?></a></center>';
                     } },
