		...
		<div class="container-fluid">
			...
			<div class="card">
				<div class="card-header <?php echo "$iden[color]"; ?>">
					<h3 class="card-title"><i class="fa fa-table"></i> <b>DATA TABEL BIAYA DAN PERSYARATAN PENDAFTARAN</b></h3>
									...
									<script type="text/javascript">
										$(function() {
											Swal.fire({
												...
												window.location = "biayapendaftaran";
											});
										});
									</script>
								<?php }       
							...
							<div class="table-responsive">
								...
								<script type="text/javascript">
									$(document).ready(function(){
										...
										{ "targets": 4, "width": '500px', "className": 'center' },
										{ "targets": 5, "width": '500px' },
										{ "targets":6, "width": '500px' },
										{
											"targets": 7, "data": 7,"width": '250px', 
											"render": function(data, type, full) {
												return '<center><div class="btn-group"><button type="button" style="width:25px;" onclick="window.location.href=\'biayapendaftaranubah?id='+data+'\'" class="btn btn-xs bg-primary" data-toggle="tooltip" title="Ubah Data"><i class="fa fa-edit"></i> </button></div></center>';
											} 
										} 
										],
