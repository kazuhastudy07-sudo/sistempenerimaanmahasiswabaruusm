		...
		<div class="container-fluid">
			...
			<div class="card">
				<div class="card-header  <?php echo "$iden[color]"; ?>">
					<h3 class="card-title"><i class="fa fa-edit (alias)"></i> <b>FORM UBAH DATA BIODATA FAKULTAS</b></h3>
					<center></center>
					<div class="card-tools">
						...
						<!-- /.card-header -->
						<div class="card-body">
							<form class='form-horizontal' role='form' method=POST action='action/biofakultas_update.php' enctype='multipart/form-data'>
								<?php
								...
								<div class="form-group">
									<div class="row">
										<div class="col-sm-6">
											...
											<input type="text" name="nama_fak" class="form-control" value="<?php echo $r['nama_fak']; ?>" required readonly>
										</div>
										<div class="col-sm-6">
											<label>Ganti Gambar Iklan Fakultas</label><br/>
											<div class="input-group">
												<div class="custom-file">
													<input type="file" name="gambar_fak" multiple="true" accept='image/*'  class="custom-file-input" id="exampleInputFile">
								...
								<div class="form-group">
									<div class="row">
										<div class="col-sm-12">
											...
											<div class="pad">
												<textarea class="textarea" name="desc_fak" style="width: 100%; height: 400px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" ><?php echo $r['desc_fak']; ?></textarea>
											</div>
										</div>
									</div>
								</div>
