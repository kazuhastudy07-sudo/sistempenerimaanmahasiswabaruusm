    ...
    <script type="text/javascript">
      $(function() {
        Swal.fire({
          ...
          window.location = "nilaipmbgelombang3";
        });
      });
    </script>
    <?php 
           ...
           <!--  <button type="button" class="btn btn-xs btn-tool btn-light"><i class="fa fa-list-ol"></i> Lihat Data</button>
            <button type="button" class="btn btn-xs btn-tool btn-light dropdown-toggle dropdown-icon" data-toggle="dropdown">
              ...
              <div class="dropdown-menu small" role="menu">
                <a class="dropdown-item small" onclick="window.location.href='nilaipmbgelombang3'" type="button"><i class="fa fa-angle-right"></i> Jalur PMDK</a>
            ...
            <!-- button type="button"  onclick="window.location.href='excel/nilaipmbgelombang3.php'" class="btn btn-xs btn-tool btn-light"  data-toggle="tooltip" title="Ekspor Data Ke Excel"><i class="fa fa-file-excel"></i> Ekspor Excel</button> -->
              ...
              <script type="text/javascript">
                $(document).ready(function(){
                  ...
                  var table = $('#tabel_kta').DataTable( {
                    ...
                    "processing": true,
                    "serverSide": true,
                    "ajax": 'serverside/nilai_pmb_gelombang3.php', 
...

                    {
                      ...
                      "render": function(data, type, full) {  
                       return '<center><div class="btn-group"><a type="button" style="width:25px;" onclick="window.location.href=\'nilaipmbgelombang3cetak?id='+data+'\'" class="btn btn-xs bg-navy" data-toggle="tooltip" title="Cetak Hasil Seleksi"><i class="fa fa-print"></i> <?php echo $a; ?></a></center>';
                     } },
...

                   {
                      ...
                      "render": function (data, type, row) {
                        if (data == '0') {
                          return "<label class='badge bg-danger'><i class='fa fa-times-circle'></i> Dipertimbangkan</label>";
                        }
                        else
                          return "<label class='badge bg-primary'><i class='fa fa-check-circle'></i> Lulus</label>";
                      }
                    },
                    { "targets": 8, "orderable": false, "searchable": true, "className": 'center',
                    "render": function(data, type, row) {
...
<div class="card-footer small">
  <small><i class="fa fa-info-circle"></i> Anda dapat melihat hasil Ujian dengan klik gambar cetak 
</div>
</div>
</div>
<!-- /.card -->
...
<form action="action/nilaipmbgelombang3_verifikasi.php" method="POST" class="form-horizontal" enctype="multipart/form-data">
...
<form action="action/nilaipmbgelombang3_delete.php" method="GET" class="form-horizontal" enctype="multipart/form-data">
...
<form action="action/nilaipmbgelombang3_reset.php" method="POST" class="form-horizontal" enctype="multipart/form-data">
