   ...
   $penghasilan_ibu=mysqli_fetch_array(mysqli_query($con, "SELECT * FROM penghasilan
    ...
    <div style="width: 700px;">
      ...
      <center>
        ...
        <p style="padding-left:45px;text-transform: uppercase;color: #222;margin-top: -20px;font-family: Arial;font-size: 7px;"><b><?php echo "$i[alamat]";?>, Desa/Kelurahan <?php echo "$i[nama_kelurahan]";?>, Kecamatan <?php echo "$i[nama_kecamatan]";?>, <?php echo "$i[nama_kabupaten]";?>, PROVINSI <?php echo "$i[nama_provinsi]";?> <br/>Telp./HP <?php echo "$i[hp]"; ?> Whatsapp <?php echo "$i[wa]"; ?> EMAIL: <?php echo "$i[email]"; ?> </b></p>
    ...
    <table>  
      ...
      <tr>
        <td style="padding-left: 15px;width: 155px;">20. Alasan Memilih UNWIKU PURWOKERTO</td>
        <td>:</td>
...
<br/>
    <table>
      ...
      <table>
        <tr>
          <td style="padding-top: 10px;"><b>E. MENGETAHUI UNWIKU PURWOKERTO DARI?</b></td>
      ...
      <table>
        <tr>
          <td colspan="3" style="text-align: right;padding-right: 40px;">Purwokerto, <?php echo "$tgl_input";?></td>
        </tr>
        <tr>
