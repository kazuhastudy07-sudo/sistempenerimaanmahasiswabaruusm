    ...
    <div class="container-fluid">
      ...
      <div class="card">
        <div class="card-header <?php echo "$iden[color]";?>">
          <h3 class="card-title"><i class="fa fa-list-ol"></i> <b>DATA PENDAFTAR PMB GELOMBANG 1</b></h3>
          ...
          <div class="card-tools">
            ...
            <button type="button"  onclick="window.location.href='excel/pmbgelombang1.php'" class="btn btn-xs btn-tool btn-light"  data-toggle="tooltip" title="Ekspor Data Ke Excel"><i class="fa fa-file-excel"></i> Ekspor Excel</button>
              ...
              <script type="text/javascript">
                $(document).ready(function(){
                  ...
                  var table = $('#tabel_kta').DataTable( {
                    ...
                    "processing": true,
                    "serverSide": true,
                    "ajax": 'serverside/pmb_gelombang1.php', 
...
<form action="action/pmbgelombang1_verifikasi.php" method="POST" class="form-horizontal" enctype="multipart/form-data">
...
<form action="action/pmbgelombang1_delete.php" method="GET" class="form-horizontal" enctype="multipart/form-data">
...
<form action="action/pmbgelombang1_reset.php" method="POST" class="form-horizontal" enctype="multipart/form-data">
