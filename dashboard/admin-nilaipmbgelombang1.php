    ...
    <div class="container-fluid">
      ...
      <div class="card">
        <div class="card-header <?php echo "$iden[color]";?>">
          <h3 class="card-title"><i class="fa fa-list-ol"></i> <b>HASIL UJIAN PMB GELOMBANG 1</b></h3>
              ...
              <script type="text/javascript">
                $(document).ready(function(){
                  ...
                  var table = $('#tabel_kta').DataTable( {
                    ...
                    "processing": true,
                    "serverSide": true,
                    "ajax": 'serverside/nilai_pmb_gelombang1.php', 
...

                    {
                      ...
                      "render": function(data, type, full) {  
                        return '<center><div class="btn-group"><a type="button" style="width:25px;" onclick="window.location.href=\'nilaipmbgelombang1cetak?id='+data+'\'" class="btn btn-xs bg-navy" data-toggle="tooltip" title="Cetak Hasil Seleksi"><i class="fa fa-print"></i> </a></center>';
                     } },
