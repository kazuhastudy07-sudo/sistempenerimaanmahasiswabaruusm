    ...
    <script type="text/javascript">
      $(function() {
        Swal.fire({
          ...
          window.location = "formulirpmbgelombang1";
        });
      });
    </script>
    <?php 
    ...
    <div class="container-fluid">
      ...
      <div class="card">
        <div class="card-header <?php echo "$iden[color]";?>">
          <h3 class="card-title"><i class="fa fa-list-ol"></i> <b>DATA FORMULIR PENDAFTAR PMB GELOMBANG 1</b></h3>
           ...
           <!--  <button type="button" class="btn btn-xs btn-tool btn-light"><i class="fa fa-list-ol"></i> Lihat Data</button>
            <button type="button" class="btn btn-xs btn-tool btn-light dropdown-toggle dropdown-icon" data-toggle="dropdown">
              ...
              <div class="dropdown-menu small" role="menu">
                <a class="dropdown-item small" onclick="window.location.href='formulirpmbgelombang1'" type="button"><i class="fa fa-angle-right"></i> Jalur PMDK</a>
            ...
            <!-- button type="button"  onclick="window.location.href='excel/formulirpmbgelombang1.php'" class="btn btn-xs btn-tool btn-light"  data-toggle="tooltip" title="Ekspor Data Ke Excel"><i class="fa fa-file-excel"></i> Ekspor Excel</button> -->
              ...
              <script type="text/javascript">
                $(document).ready(function(){
                  ...
                  var table = $('#tabel_kta').DataTable( {
                    ...
                    "processing": true,
                    "serverSide": true,
                    "ajax": 'serverside/formulir_pmb_gelombang1.php', 
...

                    {
                      ...
                      "render": function(data, type, full) {  
                       return '<center><div class="btn-group"><a type="button" style="width:25px;" onclick="window.location.href=\'formulirpmbgelombang1cetak?id='+data+'\'" class="btn btn-xs bg-success" data-toggle="tooltip" title="Cetak Formulir PMB"><i class="fa fa-print"></i> <?php echo $a; ?></a></center>';
                     } },
...
<form action="action/formulirpmbgelombang1_verifikasi.php" method="POST" class="form-horizontal" enctype="multipart/form-data">
...
<form action="action/formulirpmbgelombang1_delete.php" method="GET" class="form-horizontal" enctype="multipart/form-data">
...
<form action="action/formulirpmbgelombang1_reset.php" method="POST" class="form-horizontal" enctype="multipart/form-data">
