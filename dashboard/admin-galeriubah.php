		...
		<div class="container-fluid">
			...
			<div class="card">
				<div class="card-header  <?php echo "$iden[color]"; ?>">
					<h3 class="card-title"><i class="fa fa-edit (alias)"></i> <b>FORM UBAH DATA GALERI</b></h3>
					<center></center>
					<div class="card-tools">
						...
						<!-- /.card-header -->
						<div class="card-body">
							<form class='form-horizontal' role='form' method=POST action='action/galeri_update.php' enctype='multipart/form-data'>
								<?php
								$r=mysqli_fetch_array(mysqli_query($con, "SELECT * FROM galeri WHERE id_gal ='$_GET[id]'"));
								?>
								<input type='hidden' class='form-control' name='id_gal' value="<?php echo $r['id_gal']; ?>">

								<div class="form-group">
									<div class="row">
										<div class="col-sm-12">
											<label>Gambar Saat Ini</label><br/>
											<img class="img-responsive img-rounded img-thumbnail" alt="Responsive image" src="../assets/dist/img/galeri/<?php echo $r['gambar_gal'];?>" style="width: 100%; height: 300px; object-fit: cover;overflow: hidden;" alt="img-responsive">
											<br/>
											<label>Ganti Gambar</label>
											<div class="input-group">
												<div class="custom-file">
													<input type="file" name="gambar_gal" multiple="true" accept='image/*'  class="custom-file-input" id="exampleInputFile">
								...
								<div class="form-group">
									<div class="row">
										<div class="col-sm-12">
											...
											<input type="text" name="nama_gal" class="form-control" value="<?php echo $r['nama_gal']; ?>">
										</div>
									</div>
								</div>
							</div>
