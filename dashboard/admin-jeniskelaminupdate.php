    ...
    <div class="container-fluid">
		...
		<div class="card">
			<div class="card-header  <?php echo "$iden[color]"; ?>">
				<h3 class="card-title"><i class="fa fa-edit (alias)"></i> <b>FORM UBAH DATA JENIS KELAMIN</b></h3>
				<center></center>
				<div class="card-tools">
					...
					<!-- /.card-header -->
					<div class="card-body">
						<form class='form-horizontal' role='form' method=POST action='action/jeniskelamin_update.php' enctype='multipart/form-data'>
							<?php
							$r=mysqli_fetch_array(mysqli_query($con, "SELECT * FROM jenis_kelamin
								WHERE id_jk ='$_GET[id]'"));
								?>
								<input type='hidden' class='form-control' name='id_jk' value="<?php echo $r['id_jk']; ?>">

								<div class="form-group">
									<div class="row">
										<div class="col-sm-4 col-xs-4">
											<label>KODE JENIS KELAMIN<span class="badge text-red">*</span></label>
											<input type="text" class="form-control" value="<?php echo $r['id_jk']; ?>" disabled>
										</div>
										<div class="col-sm-8 col-xs-8">
											<label>NAMA JENIS KELAMIN<span class="badge text-red">*</span></label>
											<input type="text" name="a" class="form-control" value="<?php echo $r['nama_jk']; ?>">
										</div>
									</div>
								</div>
							</div>
							...
							<div class="card-footer">
								<div class="row">
									...
									<div class="col-sm-4 col-xs-4">
										...
										<a style='width: 150px;border-radius: 20px;border: 2px solid #FFFFFF;' onclick="location.href='jeniskelamin'" type="button" class="btn btn-sm btn-xs-2 btn-danger text-white"><i class="fa fa-remove (alias)"></i> B A T A L</a>
									</div>
								</div>
							</div>
						</form>
