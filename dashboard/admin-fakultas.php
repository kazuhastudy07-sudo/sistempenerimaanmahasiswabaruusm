...
<div class="content-wrapper">
	...
	<section class="content">
		<div class="container-fluid">
			...
			<div class="card">
				<div class="card-header <?php echo "$iden[color]"; ?>">
					<h3 class="card-title"><i class="fa fa-table"></i> <b>DATA FAKULTAS</b></h3>
					<div class="card-tools">
						<button type="button" onclick="window.location.href='fakultastambah'" class="btn btn-tool bg-navy" data-card-widget="collapse" data-toggle="tooltip" title="Tambah Data"><i class="fa fa-plus-circle"></i> Tambah Data</button>
							...
							<script type="text/javascript">
								$(document).ready(function(){
									...
									var table = $('#tabeldata').DataTable( {
										...
										{
											"targets": 2, "orderable": false, "searchable": true, "className": 'center',
											"render": function(data, type, row) {
												return '<a data-toggle=\"tooltip\" title=\"Lihat Photo\" href=\"\" onclick=\"window.open(\'../assets/dist/img/logo/'+data+'\',\'popuppage\',\'width=420,toolbar=0,resizable=0,scrollbars=yes,height=400,top=100,left=300\');\" ><img class=\"img-responsive img-rounded" alt="Responsive image\" src=\"../assets/dist/img/logo/'+data+'\" width=\"100px\"></a>'
											} 
										}, 
										{
											"targets": 3, "data": 3, 
											"render": function(data, type, full) {
												return '<center><div class="btn-group"><button type="button" style="width:25px;" onclick="window.location.href=\'fakultasubah?id='+data+'\'" class="btn btn-xs bg-primary" data-toggle="tooltip" title="Ubah Data"><i class="fa fa-edit"></i> </button><button type="button" style="width:25px;" class="btn btn-xs bg-red hapusfakultas" data-id="'+data+'" data-toggle="tooltip" title="Hapus Data"><i class="fa fa-trash"></i></button></div></center>';
											} 
										} 
										],
		...
		<script>
			$(function()
			{
				$(document).on('click','.hapusfakultas',function(e)
				{
					e.preventDefault();
					$("#hapusModal").modal('show');
					$.post('fakultas_hapus.php',
						{id_fak:$(this).attr('data-id')},
						function(html)
						{
		...
		<form action="action/fakultas_delete.php" method="GET" class="form-horizontal" enctype="multipart/form-data">
			<div class="modal fade" id="hapusModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						<div class="modal-header <?php echo "$iden[color]";?>">
							<h5 class="modal-title" id="exampleModalLabel"><i class="fa fa-edit"></i> Form Data Fakultas</h5>
