          ...
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item">
              <ol class="breadcrumb float-sm-left">
                ...
                <li class="breadcrumb-item active">Ubah Balangko</li>
              </ol>
            </li>
          </ol>
        </div><!-- /.col -->
  ...
  <section class="content">
        ...
        <script type="text/javascript">
          $(function() {
            ...
            Swal.fire({
              ...
              text: 'Data blangko kartu anda berhasil diupdate',
              footer: 'APLIKASI <?php echo "$iden[aplikasi]";?>'
            }).then(function() {
              window.location = "blangkodtc";
            });
          });
        </script>
        <?php 
    ...
    <div class="card">
      <div class="card-header ">
        <h3 class="card-title"><b><i class="fa fa-institution (alias)"></i> Form Update Blangko Kartu</b></h3>
        <div class="card-tools">
          <div class="btn-group">
            <a type="button" class="btn btn-xs bg-info" onclick="window.location.href='blangko'"><i class="fa fa-arrow-circle-left"></i> Kembali</a>
          </div>
          ...
          <div class="card-body">
            <form class='form-horizontal' role='form' method=POST action='action/blangkodtc_update.php' enctype='multipart/form-data'>
              <?php
              $r=mysqli_fetch_array(mysqli_query($con, "SELECT * FROM blangko WHERE id ='$_GET[id]'"));
              ?>
              ...
              <div class="form-group">
                <div class="row">
                  <div class="col-sm-6 col-xs-6">
                    <label>BLANGKO DEPAN<span class="badge text-red">*</span></label><br>
                    <img style="width: 100%;" class="img-thumbnail" src="../assets/dist/img/blangko/<?php echo $r['gambar']; ?>">
                    <br>
                    <br>
                  ...
                  <div class="col-sm-6 col-xs-6">
                    <label>BLANGKO BELAKANG<span class="badge text-red">*</span></label><br>
                    <img style="width: 100%;" class="img-thumbnail" src="../assets/dist/img/blangko/<?php echo $r['gambar1']; ?>">
                  </div>
                </div>
                  ...
                  <div class="row">
                    <div class="col-sm-6 col-xs-6">
                      <div class="custom-file">
                        ...
                        <label class="custom-file-label" for="exampleInputFile">Ganti Blangko Depan Kartu</label>
                        <label>NAMA BLANGKO<span class="badge text-red">*</span></label>
                        <input type="text" class="form-control" value="<?php echo $r['nama']; ?>" disabled>
                      </div>
                    </div>
                    <div class="col-sm-6 col-xs-6">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" id="exampleInputFile" name="gambar1">
                        <label class="custom-file-label" for="exampleInputFile">Ganti Blangko Belakang Kartu</label>
                        <label>UKURAN BLANGKO<span class="badge text-red">*</span></label>
                        <input type="text" class="form-control" value="<?php echo $r['ukuran']; ?>" disabled>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <div class="row">
                    <div class="col-sm-6 col-xs-6">
                      <div class="custom-file">
                        <label>JENIS KERTAS<span class="badge text-red">*</span></label>
                        <input type="text" class="form-control" value="<?php echo $r['jenis']; ?>" disabled>
                      </div>
                    </div>
                    <div class="col-sm-6 col-xs-6">
                      <div class="custom-file">
                        <label>CATATAN<span class="badge text-red">*</span></label><br>
                        Jika jenis kertas dtc, maka silahkan upload blangko depan dan belakang. Tetapi jika jenis kertas biasa (pvc) maka anda hanya perlu upload blangko depan saja!
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="card-footer">
                <div class="row">
                  ...
                  <div class="col-sm-4">
                    ...
                    <a style='width: 150px;border-radius: 20px;border: 2px solid #FFFFFF;' onclick="location.href='blangko'" type="button" class="btn btn-sm btn-xs-2 btn-danger text-white"><i class="fa fa-remove (alias)"></i> B A T A L</a>
                  </div>
                </div>
              </div>
            </form>
