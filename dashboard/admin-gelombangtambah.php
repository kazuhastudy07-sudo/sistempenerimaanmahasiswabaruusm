		...
		<div class="container-fluid">
			...
			<div class="card">
				<div class="card-header  <?php echo "$iden[color]"; ?>">
					<h3 class="card-title"><i class="fa fa-edit (alias)"></i> <b>FORM TAMBAH DATA GELOMBANG</b></h3>
					<center></center>
					<div class="card-tools">
						...
						<!-- /.card-header -->
						<div class="card-body">
							<form class='form-horizontal' role='form' method=POST action='action/gelombang_save.php' enctype='multipart/form-data'>
								...
								<div class="form-group">
									<div class="row">
										<div class="col-sm-6">
											...
											<input type="text" name="nama_gelombang" class="form-control" placeholder="Tuliskan Nama Gelombang Pendaftaran" required>
										</div>
										<div class="col-sm-6">
											<label>Biaya Pendaftaran (Rp.)<small class="text-red">Pastikan tidak memasukan tanda (,) atau (.)</small></label><br/>
											<input type="number" name="biaya" class="form-control" placeholder="Tuliskan Biaya Gelombang Pendaftaran" required>
										</div>
									</div>
								</div>
								<div class="form-group">
