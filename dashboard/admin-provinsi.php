...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="container-fluid">
		<form class='form-horizontal' role='form' method=POST action='action/provinsi_save.php' enctype='multipart/form-data'>

			<div class="card card-<?php echo "$iden[sidebar]"; ?>">											
				<div class="card-header">
					<h3 class="card-title"><i class="fa fa-plus-circle"></i> Tambah Data Provinsi</h3>
					<div class="card-tools">
						...
						<div class="card-body">
							<div class="row">
								<div class="form-group col-sm-5 col-xs-5">
									<center><input type="text" name="a" class="form-control" placeholder="Tuliskan 2 Angka Kode Provinsi Contoh: 72" required maxlength="2"  onkeypress="return hanyaAngka (event)"/></center>
								</div>
								<div class="form-group col-sm-5 col-xs-5">
									<center><input type="text" name="b" class="form-control" placeholder="Tuliskan Nama Provinsi" required></center>
								</div>
						...
						<div class="card-footer">
							Kode provinsi yang terdiri 2 digit angka diambil dari web <a href="https://sig-dev.bps.go.id/webgis/pencariankodenama" data-toggle="tooltip" title="Klik Untuk Melihat Kode Wilayah">Badan Pusat Statistik</a> yang berdasarkan wilayah kerja statistik BPS.
						</div>
					</div>
				</form>
				<!-- Default box -->
				<div class="card">
					<div class="card-header <?php echo "$iden[color]"; ?>">
						<h3 class="card-title"><i class="fa fa-table"></i> <b>DATA TABEL PROVINSI</b></h3>
						<div class="card-tools">
							<button type="button" class="btn btn-tool" data-card-widget="collapse" data-toggle="tooltip" title="Collapse">
								<i class="fa fa-minus"></i></button>
								<button type="button" class="btn btn-tool" data-card-widget="remove" data-toggle="tooltip" title="Remove">
							...
							<div class="card-body">
											...
											$(function() {
												...
												Swal.fire({
													...
													title: 'BERHASIL! TAMBAH DATA',
              										text: 'Data provinsi berhasil ditambah',
								...
								<div class="table-responsive">
									<table id="provinsi" class="table table-hover small">
										<thead class="">
								...
								<div class="card-footer small text-red">
									<i class="fa fa-info-circle"></i> Mohon untuk tidak meng-hapus data provinsi, jika telah melakukan penginputan data anggota, karena akan menyebabkan data error!
								</div>
							</div>
						</div>
					</div>
