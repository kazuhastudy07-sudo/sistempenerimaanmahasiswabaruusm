		...
		<div class="container-fluid">
			...
			<div class="card">
				<div class="card-header  <?php echo "$iden[color]"; ?>">
					<h3 class="card-title"><i class="fa fa-plus-circle"></i> <b>FORM TAMBAH DATA GALERI</b></h3>
					<center></center>
					<div class="card-tools">
						...
						<!-- /.card-header -->
						<div class="card-body">
							<form class='form-horizontal' role='form' method=POST action='action/galeri_save.php' enctype='multipart/form-data'>
										...
										<div class="col-sm-12">
											...
											<div class="input-group">
												<div class="custom-file">
													<input type="file" name="gambar_gal" multiple="true" accept='image/*'  class="custom-file-input" id="exampleInputFile" required="required">
								...
								<div class="form-group">
									<div class="row">
										<div class="col-sm-12">
											...
											<input type="text" name="nama_gal" class="form-control" placeholder="Tuliskan Nama Gambar" required="required">
										</div>
									</div>
								</div>
							</div>
