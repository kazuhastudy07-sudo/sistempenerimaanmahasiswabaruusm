...
<div class="content-wrapper">
          ...
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item">
              <ol class="breadcrumb float-sm-left">
                ...
                <li class="breadcrumb-item active">Cetak KTA Printer Biasa</li>
              </ol>
            </li>
          </ol>
        </div><!-- /.col -->
  ...
  <section class="content">
    <div class="container-fluid">
      <!-- Default box -->
      <div class="card">
        <form action="cetakpvc" method="post" class="form-horizontal" role="form">
          <div class="card-header <?php echo "$iden[color]";?>">
            <h3 class="card-title"><i class="fa fa-print"></i> <b>CETAK DATA ANGGOTA MPW PEMUDA PANCASILA </b></h3>
            <div class="card-tools">
      
                <button type="button" class="btn btn-tool" data-card-widget="collapse" data-toggle="tooltip" title="Collapse">
                  <button type="submit" class="btn btn-xs btn-dark" ><i class="fa fa-print"></i> Cetak Kartu Sekarang</button>
                  <button type="button" class="btn btn-tool" data-card-widget="collapse" data-toggle="tooltip" title="Collapse">
                  </div>
                  <button type="button" class="btn btn-tool" data-card-widget="collapse" data-toggle="tooltip" title="Collapse">
                  ...
                  <div class="card-body">
                    ...
                    "processing": true,
                    "serverSide": true,
                    "ajax": 'serverside/anggota_tandai_cetak.php',     
                    "columnDefs": [ 
                    ...
                    },
                    {
                      ...
                      "render": function(data, type, full) {
                       return '<center><input style=\"height: 20px; width: 20px;\" name=\"selector[]\" class=\"minimal flat\" value=\" '+data+' \" type=\"checkbox\" ></center>';
                     } }],
                  ...
                  <div class="card-footer">
                   <small><i class="fa fa-info-circle"></i> EKTA dapat dicetak dengan cara mencentang data dan kli tombol cetak kartu sekarang@</small>
                 </div>
               </div>
             </form>
             <!-- /.card -->
