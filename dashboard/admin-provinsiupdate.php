    ...
    <div class="container-fluid">
		...
		<div class="card">
			<div class="card-header  <?php echo "$iden[color]"; ?>">
				<h3 class="card-title"><i class="fa fa-edit (alias)"></i> <b>FORM UPDATE DATA PROVINSI</b></h3>
				<center></center>
				<div class="card-tools">
					...
					<!-- /.card-header -->
					<div class="card-body">
						<form class='form-horizontal' role='form' method=POST action='action/provinsi_update.php' enctype='multipart/form-data'>
							<?php
							$r=mysqli_fetch_array(mysqli_query($con, "SELECT * FROM provinces
								WHERE id_prov ='$_GET[id]'"));
								?>
								<input type='hidden' class='form-control' name='id_prov' value="<?php echo $r['id_prov']; ?>">

								<div class="form-group">
									<div class="row">
										<div class="col-sm-4 col-xs-4">
											<label>KODE PROVINSI<span class="badge text-red">*</span></label>
											<input type="text" class="form-control" value="<?php echo $r['id_prov']; ?>" disabled>
										</div>
										<div class="col-sm-8 col-xs-8">
											<label>NAMA PROVINSI<span class="badge text-red">*</span></label>
											<input type="text" name="a" class="form-control" value="<?php echo $r['nama_provinsi']; ?>">
										</div>
									</div>
								</div>
							</div>
							...
							<div class="card-footer">
								<div class="row">
									...
									<div class="col-sm-4 col-xs-4">
										...
										<a style='width: 150px;border-radius: 20px;border: 2px solid #FFFFFF;' onclick="location.href='provinsi'" type="button" class="btn btn-sm btn-xs-2 btn-danger text-white"><i class="fa fa-remove (alias)"></i> B A T A L</a>
									</div>
								</div>
							</div>
						</form>
