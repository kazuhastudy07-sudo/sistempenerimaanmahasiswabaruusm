...
<head>
  ...
  <body onload='window.print()' style="font-family: Arial;">
    <?php $blangko=mysqli_fetch_array(mysqli_query($con, "SELECT * FROM blangko WHERE id='1'"));
    ...
    while($r=mysqli_fetch_array($data))
    {
      ...
      <!-- Mengambil judul kartu -->
      <h1 style="transition-property: inherit;margin-top: 1930px;width: 3150px;"><?php echo "$i[motto]"; ?></h1> 
