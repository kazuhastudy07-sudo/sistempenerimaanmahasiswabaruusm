...
<script type="text/javascript">
  ...
  <h4 style="width: 200px;margin-top: -85px;margin-left:200px;text-align: center;text-transform: uppercase; padding: 5px;border: 2px dotted #222;"><?php if (trim($r['keterangan']) == '1'){ echo "";?>Lulus Tanpa Tes <br/>(Diterima)<?php } else { echo"";?>Tidak Lulus <br/>(Dipertimbangkan)<?php }?></h4>
