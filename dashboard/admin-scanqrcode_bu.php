...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark"><i class="nav-icon fa fa-search-plus faa-tada animated-hover"></i> SCAN QRCODE <?php echo "$i[aplikasi] "; ?> <i class="fa fa-qrcode"></i></h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
  ...
  <section class="content">
                    ...
                    <script type="text/javascript">
                      var arg = {
                        resultFunction: function(result) {
                         var redirect = 'validasikarpeg';
                         $.redirectPost(redirect, {otentikasi: result.code});
                       }
                     };
    ...
    <div class="col-md-4">
      <div class="callout callout-danger">
        ...
        <center><img width="75%" src="../assets/dist/img/logo/kejagungriqrcode.png" class="img-responsive img-thumbnail" alt="Responsive image"></center>
      </div>
      <!-- Info Boxes Style 2 -->
