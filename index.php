          ...
          <div class="col-sm-12">
            <div class="row">
              ...
              <div class="col-md-3 col-sm-6 col-12" type="button" onclick="window.location.href='identitas'">
                <div class="info-box">
                  <span class="info-box-icon bg-navy"><i class="fa fa-flag faa-tada animated-hover"></i></span>
                ...
                <div class="card">
                  <div class="card-header bg-navy">
                    <h3 class="card-title">
                     ...
                     Statistik Berdasarkan Gelombang
                    </h3>
                  ...
                  <div class="card-body">
                   ...
                   <script>
                    Highcharts.chart('container', {
                      ...
                      xAxis: {
                        categories: ['Gelombang 1', 'Gelombang 2', 'Gelombang 3']
                      },
                      yAxis: {
                        allowDecimals: false,
                        title: {
          ...
          <div class="card card-navy">
            <div class="card-header">
              <h3 class="card-title"><i class="fas fa-chart-bar mr-1"></i>
                     Statistik Berdasarkan Program Studi</h3>
              <div class="card-tools">
                <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-minus"></i></button>
                <button type="button" class="btn btn-tool" data-card-widget="remove"><i class="fas fa-times"></i></button>
              </button>
          ...
          <div class="card-body">
           ...
           <script>
            Highcharts.chart('containerr', {
              ...
              xAxis: {
                categories: ['Sains Innformasi', 'Teknik Informatika', 'Sains Data', 'Sains Komunikasi', 'Kewirausahaan', 'Film dan TV']
              },
              yAxis: {
                allowDecimals: false,
                title: {
            ...
            series: [{
              name: 'Jumlah Data ',
              data: [<?php echo $pro1; ?>, <?php echo $pro2; ?>, <?php echo $pro3; ?>, <?php echo $pro4; ?>, <?php echo $pro5; ?>, <?php echo $pro6; ?>],
            },]
          });
        </script>
        <small><i class="fa fa-info-circle"></i> Data yang kami tampilkan adalah data pendaftar yang sudah terverifikasi!</small>
