    ...
    <script type="text/javascript">
      $(function() {
        ...
        Swal.fire({
          ...
          window.location = "verifikasiexcel";
        });
      });
    </script>
    <?php 
    ...
    <script type="text/javascript">
      $(function() {
        ...
        Swal.fire({
          ...
          timerProgressBar: true,
          title: 'Sukses!',
          text: 'Data Anggota Berhasil Diupload, Silahkan verifikasi data!',
          footer: 'APLIKASI <?php echo "$iden[aplikasi]";?>'
        }).then(function() {
          window.location = "verifikasiexcel";
        });
    ...
    <div class="container-fluid">
      ...
      <div class="card">
        <div class="card-header <?php echo "$iden[color]";?>">
          <h3 class="card-title"><i class="fa fa-check-square"></i><b>VERIFIKASI DATA ANGGOTA <i class="fa fa-arrow-circle-right"></i> DAFTAR UPLOAD EXCEL</b></h3>
              ...
              <div class="table-responsive">
                ...
                <script type="text/javascript">
                  $(document).ready(function(){
                    ...
                    "processing": true,
                    "serverSide": true,
                    "ajax": 'serverside/anggota_excel.php',     
                    "columnDefs": [ 
                    { "targets": 0, "data": '1', "orderable": true, "searchable": true, "width": '30px', "className": 'center' },{
                      "targets": 1, "className": 'center',
                      "render": function(data, type, row) {
                        return '<a type=\"submit\" class=\"editdata\" data-id=\"'+data+'\"><span class="badge bg-dark" data-toggle=\"tooltip\" title=\"Detail\">'+data+'<span></a>'
                      } 
                    },                    
                    ...
                    { "targets": 5,  "className": 'right' },  
                    {
                      ...
                      "render": function(data, type, full)  {
                        return '<center><a type=\"submit\" class=\"detailanggota\" data-id=\"'+data+'\"><span class="btn btn-xs bg-red" data-toggle=\"tooltip\" title=\"Detail Data\"><i class="fa fa-user"></i><span></a></center>'
                      } 
                    },
                    {
                      "targets": 7, "data": 7, 
                      "render": function(data, type, full) {
                        return '<center><div class="btn-group"><button type="submit" class="btn btn-xs btn-primary terimaanggota" data-id=\"'+data+'" data-toggle=\"tooltip\" title=\"Terima\"><i class="fa fa-check-circle"></i></button><button type="submit" class="btn btn-xs bg-navy tolakanggota" data-id=\"'+data+'" data-toggle=\"tooltip\" title=\"Tolak\"><i class="fa fa-times-circle"></i></button></div></center>';
                          ...
                          "order": [[ 7, "desc"]],           // urutkan data berdasarkan id_transaksi secara descending
...
<div class="card-footer">
  <small><i class="fa fa-info-circle"></i> Data Anggota Anggota Hasil Upload Excel Tidak Memiliki File Photo dan KTP, Silahkan Lakukan Pengeditan Saat Data Sudah Diverifikasi!</small>
</div>
</div>
</div>
<!-- /.card -->
...
<form action="action/anggota_verifikasi_excel.php" method="POST" class="form-horizontal" enctype="multipart/form-data">
...
<form action="action/anggota_tolak_excel.php" method="GET" class="form-horizontal" enctype="multipart/form-data">
