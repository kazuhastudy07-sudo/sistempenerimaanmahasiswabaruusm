...
<div class="content-wrapper">
	...
	<section class="content">
		<div class="container-fluid">
			...
			<div class="card">
				<div class="card-header <?php echo "$iden[color]"; ?>">
					<h3 class="card-title"><i class="fa fa-table"></i> <b>DATA BANK SOAL</b></h3>
					<div class="card-tools">
						<button type="button" onclick="window.location.href='soaltambah'" class="btn btn-tool bg-navy"  data-toggle="tooltip" title="Tambah Data"><i class="fa fa-plus-circle"></i> Tambah Data</button>
					...
					<div class="card-body">
							...
							<script type="text/javascript">
								$(document).ready(function(){
									...
									var table = $('#tabeldata').DataTable( {
										...
										"processing": true,
										"serverSide": true,
										"ajax": 'serverside/soal.php',     
										"columnDefs": [ 
										{ "targets": 0, "data": null, "orderable": true, "searchable": true, "width": '30px', "className": 'center' },
										{
											"targets": 1, "className": 'center', "width": '400px',
											"render": function(data, type, row) {
												return '<small> '+data+'<smal>'
											} 
										},
                      ...
                      "render": function (data, type, row) {
                        if (data == '') {
                          return "<label class='badge bg-danger'><i class='fa fa-image'></i> Tidak Ada Gambar</label>";
                        }
                        else
                          return "<img class='img-responsive img-rounded' src='../assets/dist/img/soal/"+data+"\' style='border: 1px solid #007bff;height:40px;width:40px;object-fit: cover;overflow: hidden;'>";
                      }
                    },
										{
...

										{
											...
											"render": function(data, type, full) {
												return '<center><div class="btn-group"><button type="button" style="width:25px;" onclick="window.location.href=\'soalubah?id='+data+'\'" class="btn btn-xs bg-primary" data-toggle="tooltip" title="Ubah Data"><i class="fa fa-edit"></i> </button><button type="button" style="width:25px;" class="btn btn-xs bg-red hapussoal" data-id="'+data+'" data-toggle="tooltip" title="Hapus Data"><i class="fa fa-trash"></i></button></div></center>';
											} 
										} 
										],
		...
		<form action="action/soal_delete.php" method="GET" class="form-horizontal" enctype="multipart/form-data">
			<div class="modal fade" id="hapusModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						<div class="modal-header <?php echo "$iden[color]";?>">
							<h5 class="modal-title" id="exampleModalLabel"><i class="fa fa-edit"></i> Form Data soal</h5>
