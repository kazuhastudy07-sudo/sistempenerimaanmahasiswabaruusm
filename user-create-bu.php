    ...
    <body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed pace-white">
      ...
      <nav class="main-header navbar navbar-expand navbar- <?php echo "$iden[color]"; ?>  navbar-dark">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item d-none d-sm-inline-block">
            <a onclick="window.location.href='administrator'" type="submit" class="active nav-link" style="text-transform: uppercase;">
              Aplikasi <?php echo "$iden[nama]"; ?>
            </a>
          </li>
        </ul>
      ...
      <aside class="main-sidebar sidebar-<?php echo "$iden[mode]"; ?>-<?php echo "$iden[sidebar]"; ?> elevation-4">
        ...
        <a type="button" onclick="window.location.href='administrator'" class="brand-link text-white <?php echo "$iden[color]"; ?>">
          ...
          style="opacity: ">
          <span class="brand-text small font-weight-light"><?php echo "$iden[aplikasi]";?> <i class="fa fa-qrcode"></i></span>
        </a>
          ...
          <nav class="mt-2 small">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
              ...
              <li class="nav-item has-treeview menu-open">
                <a type="button" onclick="window.location.href='./'" class="nav-link bg-light">
