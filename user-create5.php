...
<body class="hold-transition layout-top-nav">
  <div class="wrapper">
        ...
        <script type="text/javascript">
          $(function() {
            ...
            Swal.fire({
              ...
              title: 'Sukses!',
              text: 'Anda Berhasil Mendaftar, Silahkan Login Menggunakan Username dan Password Anda, Untuk Melihat Informasi Pembayaran Biaya Pendaftaran',
        ...
        <script type="text/javascript">
          $(function() {
            ...
            Swal.fire({
              icon: 'error',
              title: 'GAGAL!',
              text: 'Email/NIK Sudah Terdaftar, Silahkan Unggah Kembali File dan Tekan Tombol Kirim Formulir Pendaftaran',
              footer: 'APLIKASI <?php echo "$iden[aplikasi]";?>'
            })
          });
        </script>
          ...
          <div class="card card-primary card-outline card-outline-tabs">
            <div class="card-header p-0 border-bottom-0">
              <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                ...
                <li class="nav-item">
                  <a class="nav-link active" id="custom-tabs-four-settingss-tab" data-toggle="pill" href="#custom-tabs-four-settingss" role="tab" aria-controls="custom-tabs-four-settingss" aria-selected="false"><i class="fa fa-cloud-upload"></i> Unggah Berkas</a>
                </li>
              </ul>
            </div>
            <div class="card-body">
    ...
    <div class="tab-pane fade" id="custom-tabs-four-settings" role="tabpanel" aria-labelledby="custom-tabs-four-settings-tab">
     <form role="form" method="POST" action="daftar-step5" enctype='multipart/form-data'>
      ...
      <div class="row">
        <div class="col-sm-12">
          <center>
            <?php $ikl = mysqli_fetch_array(mysqli_query($con, "SELECT * FROM iklan WHERE id_iklan='1'")); 
            $i1 = $ikl["gambar_iklan"]; ?>
            <img style="border-bottom-right-radius: 20px;border-top-left-radius: 20px;border: 4px solid #eee;" class="img-responsive" alt="Responsive image" src="../assets/dist/img/iklan/<?php echo "$i1"; ?>" width="50%">
          </center>
          <hr>
        </div>
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <select class="form-control" id="statuspegawai" name="id_fak" required="true" style="width: 100%">
              ...
              while($rs_sp = mysqli_fetch_array($sql_sp)){ ?> 
                <option class="<?php echo $_SESSION['id_fak'];?>" value="<?php echo $rs_sp['id_fak']; ?>" <?php echo $rs_sp['id_fak'] == $_SESSION['id_fak'] ? 'selected="selected"' : '' ?>><?php echo $rs_sp['nama_fak']; ?></option>
                <?php
              }
              ?>
            </select>
        ...
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <select class="form-control" id="pangkat" name="id_pro" required="true" style="width: 100%">
              <option></option>
              <?php $sql_p= mysqli_query($con, "SELECT * FROM prodi WHERE id_fak ='$_SESSION[id_fak]' ORDER BY nama_pro ASC");                      
              while($rs_p = mysqli_fetch_array($sql_p)){ ?> 
                <option class="<?php echo $_SESSION['id_pro'];?>" value="<?php echo $rs_p['id_pro']; ?>" <?php echo $rs_p['id_pro'] == $_SESSION['id_pro'] ? 'selected="selected"' : '' ?>><?php echo $rs_p['nama_pro']; ?></option>
                <?php
              }
              ?>
            </select>
      ...
      <div class="card-footer">
        <div class="row">
          <div class="col-sm-12">
            <i class="fa  fa-info-circle"></i>  Step 4 dari 5!   
            <div class="progress progress-xs">
              <div class="progress-bar bg-warning progress-bar-striped" role="progressbar"
...
<div class="tab-pane fade show active" id="custom-tabs-four-settingss" role="tabpanel" aria-labelledby="custom-tabs-four-settingss-tab">
  <form role="form" method="POST" action="pmb_save.php" enctype='multipart/form-data'>
    ...
    <div class="row">
      <div class="col-sm-6">
        <div class="form-group">
          <label>Scan & Unggah KTP<?php echo $_SESSION['ktp'];?><sup class="text-red">*file (.jpg)</sup></label>
          <div class="input-group">
            <div class="custom-file">
              <input type="file" name="ktp" value="<?php echo $_SESSION['ktp'];?>"  multiple="true" accept='image/*'  class="custom-file-input" id="exampleInputFile" required="required">
              <label class="custom-file-label" for="exampleInputFile">Unggah KTP</label>
            </div>
          </div>
        </div>
      </div> 
      <div class="col-sm-6">
        <div class="form-group">
          <label>Scan & Unggah Kartu Keluarga<sup class="text-red">*file (.jpg)</sup></label>
          <div class="input-group">
            <div class="custom-file">
              <input type="file" name="kk" value="<?php echo $_SESSION['kk'];?>" multiple="true" accept='image/*'  class="custom-file-input" id="exampleInputFile1" required="required">
              <label class="custom-file-label" for="exampleInputFile">Unggah Kartu Keluarga</label>
            </div>
          </div>
        </div>
      </div> 
      ...
      <div class="col-sm-6">
        <div class="form-group">
          <label>Scan & Unggah Akta Kelahiran<sup class="text-red">*file (.jpg)</sup></label>
          <div class="input-group">
            <div class="custom-file">
              <input type="file" name="akta" value="<?php echo $_SESSION['akta'];?>" multiple="true" accept='image/*'  class="custom-file-input" id="exampleInputFile2" required="required" >
              <label class="custom-file-label" for="exampleInputFile">Unggah Akta Kelahiran</label>
            </div>
          </div>
        </div>
      </div> 
      ...
      <div class="col-sm-6">
        <div class="form-group">
          <label>Scan & Unggah Pas Photo<sup class="text-red">*file (.jpg)</sup> <badge class="badge bg-red">Ukuran 3x4 cm</badge></label>
          <div class="input-group">
            <div class="custom-file">
              <input type="file" name="gambar" value="<?php echo $_SESSION['gambar'];?>" multiple="true" accept='image/*'  class="custom-file-input" id="exampleInputFile3" required="required">
      ...
      <div class="col-sm-6">
        <div class="form-group">
          <label>Scan & Unggah Ijazah/SKL Legalisir<sup class="text-red">*file (.jpg)</sup> <badge class="badge bg-red">Upload Rapor Semester Gasal/Ganjil Untuk Pendaftar Jalur PMDK</badge></label>
          <div class="input-group">
            <div class="custom-file">
              <input type="file" name="ijazah" value="<?php echo $_SESSION['ijazah'];?>" multiple="true" accept='image/*'  class="custom-file-input" id="exampleInputFile4" required="required">
      ...
      <div class="col-sm-6">
        <div class="form-group">
          <label>Scan & Unggah  Piagam Sertifikat<sup class="text-red">*</sup> <badge class="badge bg-red">Bila Ada</badge></label>
          <div class="input-group">
            <div class="custom-file">
              <input type="file" name="piagam" value="<?php echo $_SESSION['piagam'];?>" multiple="true" accept='image/*'  class="custom-file-input" id="exampleInputFile6">
    ...
    <div class="card-footer">
      <div class="row">
        <div class="col-sm-12">
          <i class="fa  fa-info-circle"></i>  Step 5 dari 5!   
          <div class="progress progress-xs">
            <div class="progress-bar bg-warning progress-bar-striped" role="progressbar"
      ...
      <div class="col-sm-12">
        <br/>
        <button style='width: 250px;border-radius: 20px;border: 2px solid #FFFFFF;' type="submit" class="btn btn-sm btn-xs-2 btn-primary pull-right"><i class="fa fa-send"></i> Kirim Formulir Pendaftaran</button>
