        ...
        <div class="card-body">
          <div class="tab-content" id="custom-tabs-four-tabContent">
            ...
            <div class="tab-pane fade show active" id="custom-tabs-four-home" role="tabpanel" aria-labelledby="custom-tabs-four-home-tab">
              <form role="form" method="POST" action="action/pmb_update.php" enctype='multipart/form-data'>
              ...
              <div class="tab-pane fade" id="custom-tabs-four-profile" role="tabpanel" aria-labelledby="custom-tabs-four-profile-tab">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      <label>No. Handphone<sup class="text-red">*</sup> <badge class="badge bg-red">Whatsapp</badge></label>
            ...
            <div class="tab-pane fade" id="custom-tabs-four-settingss" role="tabpanel" aria-labelledby="custom-tabs-four-settingss-tab">
             <div class="row">
              <div class="col-sm-6">
                <div class="form-group">
                  <label>Scan & Unggah KTP<sup class="text-red">*file (.jpg)</sup>  <a href="#" onclick="window.open('../assets/dist/img/ktp/<?php echo "$r[ktp]";?>','popuppage','width=500,toolbar=0,resizable=0,scrollbars=no,height=500,top=100,left=300');" class="btn btn-xs bg-info" data-toggle='tooltip' title="Lihat Ijazah/SKL"><i class="fa fa-eye"></i> Lihat KTP
                  </a></label>
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  <label>Scan & Unggah Kartu Keluarga<sup class="text-red">*file (.jpg)</sup>  <a href="#" onclick="window.open('../assets/dist/img/kk/<?php echo "$r[kk]";?>','popuppage','width=500,toolbar=0,resizable=0,scrollbars=no,height=500,top=100,left=300');" class="btn btn-xs bg-info" data-toggle='tooltip' title="Lihat Kartu Keluarga"><i class="fa fa-eye"></i> Lihat Kartu Keluarga
                  </a></label>
                  <div class="input-group">
                    <div class="custom-file">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  <label>Scan & Unggah Ijazah/SKL Legalisir<sup class="text-red">*file (.jpg)</sup>  <a href="#" onclick="window.open('../assets/dist/img/ijazah/<?php echo "$r[ijazah]";?>','popuppage','width=500,toolbar=0,resizable=0,scrollbars=no,height=500,top=100,left=300');" class="btn btn-xs bg-info" data-toggle='tooltip' title="Lihat Ijazah/SKL"><i class="fa fa-eye"></i> Lihat Ijazah/SKL
                  </a></label>
                  <div class="input-group">
                    <div class="custom-file">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  <label>Scan & Unggah Surat Keterangan Bekerja Dari PimpinanDari Pimpinan<sup class="text-red">*file (.jpg)</sup> <badge class="badge bg-red">Untuk Pendaftar Kelas Karyawan/Pararel</badge> <a href="#" onclick="window.open('../assets/dist/img/suratkerja/<?php echo "$r[surat_kerja]";?>','popuppage','width=500,toolbar=0,resizable=0,scrollbars=no,height=500,top=100,left=300');" class="btn btn-xs bg-info" data-toggle='tooltip' title="Lihat Surat Kerja"><i class="fa fa-eye"></i> Lihat Surat Kerja
                  </a></label>
                  <div class="input-group">
                    <div class="custom-file">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  <label>Scan & Unggah  Piagam Sertifikat<sup class="text-red">*file (.jpg)</sup>  <a href="#" onclick="window.open('../assets/dist/img/piagam/<?php echo "$r[piagam]";?>','popuppage','width=500,toolbar=0,resizable=0,scrollbars=no,height=500,top=100,left=300');" class="btn btn-xs bg-info" data-toggle='tooltip' title="Lihat Piagam"><i class="fa fa-eye"></i> Lihat Piagam</a></label>
                  <div class="input-group">
                    <div class="custom-file">
