		...
		<div class="container-fluid">
			...
			<div class="card">
				<div class="card-header  <?php echo "$iden[color]"; ?>">
					<h3 class="card-title"><i class="fa fa-plus-square"></i> <b>FORM TAMBAH DATA SOAL</b></h3>
					<center></center>
					<div class="card-tools">
						...
						<!-- /.card-header -->
						<div class="card-body">
							<form class='form-horizontal' role='form' method="POST" action='action/soal_save.php' enctype='multipart/form-data'>
								<div class="row">
									<div class="col-sm-12">
										<div class="form-group">
											...
											<div class="pad">
												<textarea class="textarea" name="soal" style="width: 100%; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" required="required"></textarea>
											</div>
										</div>
									</div> 
									<div class="col-sm-6">
										<div class="form-group">
											...
											<div class="input-group">
												<div class="custom-file">
													...
													<label class="custom-file-label" for="exampleInputFile">Unggah Gambar Soal</label>
												</div>
											</div>
										</div>
									</div> 
										...
										<div class="form-group">
											...
											<select class="form-control" name="knc_jawaban" id="pilihan" required="required" style="width:100%; text-transform: uppercase;">
												...
												while($row=mysqli_fetch_array($tampil)) {
													?>
													<option class="text-red" style="text-transform: uppercase;"  class="<?php echo $_SESSION['id_plh'] ?>"  value="<?php echo $row['nama_plh'];?>" <?php echo $row['nama_plh'] == $_SESSION['nama_plh'] ? 'selected="selected"' : '' ?>><?php echo $row['kode_plh']; ?></option>
													<?php
												}
												?>
											</select>
									...
									<div class="col-sm-6">
										<div class="form-group">
											...
											<div class="pad">
												<textarea class="textarea" name="a" style="width: 100%; height: 400px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" required="required"></textarea>
											</div>
										</div>
									</div> 
									<div class="col-sm-6">
										<div class="form-group">
											...
											<div class="pad">
												<textarea class="textarea" name="b" style="width: 100%; height: 400px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" required="required"></textarea>
											</div>
										</div>
									</div> 
									<div class="col-sm-6">
										<div class="form-group">
											...
											<div class="pad">
												<textarea class="textarea" name="c" style="width: 100%; height: 400px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" required="required"></textarea>
											</div>
										</div>
									</div> 
									<div class="col-sm-6">
										<div class="form-group">
											...
											<div class="pad">
												<textarea class="textarea" name="d" style="width: 100%; height: 400px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" required="required"></textarea>
											</div>
										</div>
									</div> 
								</div> 
