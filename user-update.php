...
<div class="container" style="margin-top: 70px;">
  ...
  <section class="content">
     ...
     <?php
            ...
            $r=mysqli_fetch_array(mysqli_query($con, "SELECT * FROM users  WHERE id_user ='$id'"));

            $ide = encrypt_decrypt('encrypt',$r['id']); 
            $tgl = date("Y-m-d", strtotime($r['tgl_lhr']));
            $id = $r['id'];
            $ids = sprintf("%07s", $id);
    ...
    <div class="card">
      <div class="card-header <?php echo "$iden[color]";?>">
        <h3 class="card-title"><b><i class="fa fa-pencil"></i> Form Ubah Data Anggota</b></h3>
        <div class="card-tools">
          <div class="btn-group">
            <a type="button" class="btn btn-xs bg-dark" onclick="window.history.go(-1); return false;"><i class="fa fa-arrow-circle-left"></i> Kembali</a>
          ...
          <div class="card-body">
            ...
            <form action="action/anggota_update_user.php" method='POST' enctype='multipart/form-data'>
              <input type="hidden" name="id_user" value="<?php echo $r['id_user']; ?>">
              <input type="hidden" name="noreg" value="<?php echo $r['noreg']; ?>">
              <div class="row">
           ...
           <div class="card-footer">
            <div class="row">
              ...
              <div class="col-sm-4">
                ...
                <a style='width: 150px;border-radius: 20px;border: 2px solid #FFFFFF;'  onclick="window.history.go(-1); return false;" type="button" class="btn btn-sm btn-xs-2 btn-danger text-white"><i class="fa fa-times-circle"></i> BATAL</a>
              </div>
            </div>
          </div>
        </form>
